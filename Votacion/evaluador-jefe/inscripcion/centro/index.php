...
<table width="315" height="248" border="1" align="center" cellspacing="4" bgcolor="#CCCCCC">
  ...
  <tr>
    <th bgcolor="#FFFFFF" scope="row"> <form id="form1" name="form1" method="post" action="ingreso.php">
      <table width="301" border = '0' align="center">
        <tr>
          <td colspan="2" align="center" valign="middle"><h2><u>Ingreso Centro Gestion</u></h2></td>
          </tr>
        <tr>
