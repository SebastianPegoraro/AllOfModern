...
if($info==2){
$queEmp = "SELECT `juris` as Jurisdicciones, COUNT(DISTINCT `npostulante`) AS Cantidad_de_Postulantes FROM votos group by(`juris`)";
abrirBase();
$resEmp = mysql_query($queEmp) or die(mysql_error());
$totEmp = mysql_num_rows($resEmp);
cerrarBase();
...
$titles = array(
	'Jurisdicciones'=>'<b>Jurisdiccion</b>',
	'Cantidad_de_Postulantes'=>'<b>Cantidad de Postulantes</b>',
	);
$options = array(
				'shadeCol'=>array(0.9,0.9,0.9),
				'xOrientation'=>'center',
