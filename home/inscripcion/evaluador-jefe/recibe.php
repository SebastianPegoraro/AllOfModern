...
conectar();
	mysql_query("SET NAMES 'utf8'");
	$result = mysql_query("INSERT INTO evaluacion (dnipostul, cargo, npost, dedicacion1, dedicacion2, obserdedica, supera1, supera2, obsersupera, proact1, proact2, obserproact, aprend1, aprend2, obseraprend, comyresp1, comyresp2, obsercompyresp, resppyp1, resppyp2, obserresppyp, punt1, punt2, obserpunt, colycop1, colycop2, obsercolycop, honest1, honest2, obserhonest, total,apynomjefe, cargojefe, mailjefe) VALUES( '$dni','$cargo','$npostul','$dedicacion1','$dedicacion2','$obserdedica','$supera1','$supera2','$obsersupera','$proact1','$proact2','$obserproact','$aprend1','$aprend2','$obseraprend','$comyresp1','$comyresp2','$obsercompyresp','$resppyp1','$resppyp2','$obserrespyp','$punt1','$punt2','$obserpunt','$colycop1','$colycop2','$obsercolycop','$honest1','$honest2','$obserhonest','$total','$apynomjefe','$cargojefe','$mailjefe')"); 
...
//$fichero = fopen("formularios/$id_formulario.pdf",'wb');
...
$mail= new PHPMailer();
$mail->FromName ="";
$mail->Subject = "Formulario Completo - $apynomjefe";
$mail->AddAddress($mailjefe,"Nombre");
$mail->AddBCC("premioempleadopublico@gmail.com");

$cuerpo="
*Hemos recibido correctamente la evaluación del postulante $apeynom.
...
//$mail->AddAttachment("formularios/$id_formulario.pdf","formulario.pdf");
$mail->Send();
