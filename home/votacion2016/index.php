...
<body>
	<a class="boton-voto" href="#"><img src="images/10antiguedad.png" alt="Votá acá"></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<h2>
					A QUIEN QUERES VOTAR?<br>
					<small>INGRESA EL DNI Y LA JURISDICCI&Oacute;N QUE APARECE EN EL RECIBO DE SUELDO</small>
				</h2>
...
<table width="315" height="248" border="1" align="center" cellspacing="4" bgcolor="#CCCCCC">
  ...
  <tr>
    <th bgcolor="#FFFFFF" scope="row"> <form id="form1" name="form1" method="post" action="control.php">
...
<br/>
<br/> DEL AÑO 2015</em><br />
<br /></td>
        </tr>
        <tr>
          <td width="76" align="center">DNI:</td>
          <td width="215" align="center"><span id="sprytextfield1">
          <label for="dni"></label>
          <input name="dni" type="text" id="dni" size="30" />
          <br />
          <span class="textfieldRequiredMsg">Se necesita un valor.</span><span class="textfieldInvalidFormatMsg">Solo se permiten numeros.</span></span></td>
        </tr>
        <tr>
...
<script type="text/javascript">
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "integer", {hint:"Ingrese su DNI"});
</script>
</body>
</html>
