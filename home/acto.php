  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-xs-9 acto text-center">
        ...
        <br>
        <br>
        <form id="form1" name="form1" class="form-horizontal" action="acto.html" method="post">
          <input type="text" name="dniagasajado" id="dniagasajado" class="form-control dni">
