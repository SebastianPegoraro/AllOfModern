...
//  4
	...
	//  9
	$data[] = array('valor'=>"Concepto9: Honestidad", 'punt'=>"");
	$muestra28=valor($row[28]);
	$data[] = array('valor'=>"Se comporta y expresa con coherencia y sinceridad.", 'punt'=>"$muestra28");
	$muestra29=valor($row[29]);
	$data[] = array('valor'=>"Orienta su vida y su trabajo según sus valores.", 'punt'=>"$muestra29");
...
$pdf->ezText("EMPLEADO PUBLICO 2013", 14);
$pdf->ezText("N Postulante = $row[3]\n", 14);
