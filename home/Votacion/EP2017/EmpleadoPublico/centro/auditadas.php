...
error_reporting(0);
	...
	$result = mysql_query("SELECT dnipostul, NomyApePos, juris, dnivot, NomyApeVot, obseraudi FROM votos WHERE auditado='Si'");
	desconectar();
?>
<table width="1056" border="1" align="center" cellspacing="4" bgcolor="#FFFFFF">
  <tr>
    <th width="189" height="101" bgcolor="#FFFFFF" scope="row"><h1>Listado de Personas Auditadas</h1></th>
  ...
  <tr>
    <th height="65" colspan="2" scope="row"><table width="100%" border="1" cellspacing="4" bgcolor="#CCCCCC">
      <tr>
        ...
        <td width="19%" bgcolor="#FFFFFF">Apellido y Nombre<br />Votante</td>
        <td width="20%" bgcolor="#FFFFFF">Observaciones de la Auditoria</td>
        </tr>
      <?php
      ...
      <tr>
        ...
        <td align="left" bgcolor="#FFFFFF"><?php echo $row['obseraudi']; ?></td>
        </tr>
      <?php }?>
    </table></th>
  </tr>
