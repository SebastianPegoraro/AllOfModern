...
<body ng-app="pep2016">
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
	...
	<div class="container">
      ...
      <form class="well">
        <h2>
  				TELÉFONO GUARDADO CORRECTAMENTE!<br>
  				<small>Estaremos en contacto en la brevedad.</small>
  			</h2>
		...
		<div class="row">
          ...
          <div class="col-md-4 col-xs-4" style="text-align: center;">
            <a href="docs/invitacion.pdf" target="_blank">
          		<strong>
          			<i class="fa fa-8x fa-file-pdf-o"></i>
          			<br><br>
          			<i class="fa fa-download"></i> INVITACION
          		</strong>
          	</a>
          </div>
        </div>
