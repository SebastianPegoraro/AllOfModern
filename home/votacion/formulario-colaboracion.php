...
<table>
	<tr>
		<td>
			<div class="checkbox">
			 <label><input type="checkbox" name="check1" id="check1" value="Medioambiente">Medioambiente</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check2" value="Salud">Salud</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check3" value="Inclusi&oacuten Social">Inclusi&oacuten Social</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check4" value="Seguridad">Seguridad</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check5" value="Defensa del Consumidor">Defensa del Consumidor</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check6" value="Educaci&oacuten">Educaci&oacuten</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check7" value="Ni&ntildeez, Adolescencia y Familia">Ni&ntildeez, Adolescencia y Familia</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check8" value="Asistencia Social">Asistencia Social</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check9" value="Recreaci&oacuten">Recreaci&oacuten</label>
			</div>
		</td>
	</tr>
	<tr>
