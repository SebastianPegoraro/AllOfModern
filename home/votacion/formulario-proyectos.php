...
<table width="1013" border="0" cellspacing="4">
       ...
       <input type="checkbox" name="categoria" value="Proyectos" style="visibility: hidden;" checked>
...
<table>
  <tr>
    <td>
			<div class="checkbox">
			 <label><input type="checkbox" name="check1" value="Transparencia y acceso a la información">Transparencia y acceso a la información</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check2" value="Gestión de trámites">Gestión de trámites</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check3" value="Mejora continua de trámites">Mejora continua de trámites</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check4" value="Participación ciudadana">Participación ciudadana</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check5" value="Servicio de atención al ciudadano">Servicio de atención al ciudadano</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check6" value="Mejoras en la gestión pública">Mejoras en la gestión pública</label>
			</div>
		</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left" valign="top"><span id="obser3">
      ...
      <p>                  <textarea name="obser3" id="obser3" cols="120" rows="11" placeholder="Escriba aqu&iacute"></textarea>
                        </span></p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top"><span id="obser9">
      ...
      <p>                  <textarea name="obser9" id="obser9" cols="120" rows="11" placeholder="Escriba aqu&iacute"></textarea>
                        </span></p>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="left" valign="top"><span id="obser10">
      ...
      <p>                  <textarea name="obser10" id="obser10" cols="120" rows="11" placeholder="Escriba aqu&iacute"></textarea>
                        </span></p>
    </td>
  </tr>
</table>
