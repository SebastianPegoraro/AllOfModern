...
<table>
	...
	<tr>
		<td align="left" valign="top"><span id="obser3">
			<label align="left">¿C&oacutemo constribuye su nivel acad&eacutemico a su desempe&ntildeo laboral?</label>
	...
	<tr>
        ...
        <textarea name="obser4" id="obser4" cols="120" rows="11" placeholder="Detalle aqu&iacute el nombre de la instituci&oacuten, el nombre del curso y su duraci&oacuten. Si son varios, repita el procedimiento."></textarea>
        </span>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td align="left" valign="top"><span id="obser6">
			<label align="left">¿Comparte los conocimientos adquiridos con sus compa&ntildeeros de trabajo?</label>
	...
	<tr>
        ...
        <textarea name="obser10" id="obser10" cols="120" rows="11" placeholder="Escriba aqu&iacute"></textarea>
        </span>
		</td>
	</tr>
