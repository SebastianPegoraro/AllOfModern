...
<table width="1013" border="0" cellspacing="4">
       ...
       <input type="checkbox" name="categoria" value="Innovacion" style="visibility: hidden;" checked>
...
<table>
  ...
  <tr>
    <td>
			<div class="checkbox">
			 <label><input type="checkbox" name="check1" value="Procesos deficientes">Procesos deficientes</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check2" value="Tecnologías obsoletas o desactualizadas">Tecnologías obsoletas o desactualizadas</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check3" value="Canales de información/comunicación inapropiados o inexistentes">Canales de información/comunicación inapropiados o inexistentes</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check4" value="Atención deficiente a los ciudadanos">Atención deficiente a los ciudadanos</label>
			</div>
			<div class="checkbox">
			 <label><input type="checkbox" name="check5" value="Desperdicio de insumos">Desperdicio de insumos</label>
			</div>
		</td>
  </tr>
	<tr>
