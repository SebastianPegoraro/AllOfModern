  ...
  <tr>
    <th height="65" colspan="3" scope="row"><table width="100%" border="1">
      ...
      <tr>
        ...
        <tr>
          <td colspan="5" align="center">Concepto9: Ética laboral</td>
        </tr>
        <tr>
          <td width="559" align="left"><p>Es leal a los principios del organismo.</p></td>
          <td colspan="4" align="left"><?php $muestra=valor($row[28]); echo "$muestra"; ?></td>
</tr>
        <tr>
          <td align="left"><p>Cuida los bienes del Estado y sus recursos, velando por la economía del material y la información que le fueron confiados.</p></td>
