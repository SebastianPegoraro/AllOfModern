...
//  4
	...
	$data[] = array('valor'=>"Cuida los bienes del Estado y sus recursos, velando por la economía del material y la información que le fueron confiados.", 'punt'=>"$muestra29");
