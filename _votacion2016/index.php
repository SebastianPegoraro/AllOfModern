	  ...
	  <div class="container">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav navbar-center"> 
	        <li>
	        	<a href="http://premioep.chaco.gov.ar/"><i class="fa fa-lg fa-home"></i>&nbsp;&nbsp;Portada</a>
	        </li>       	
	      </ul>
	    </div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<h2>
					...
					<small>INGRESA TU DNI</small>
				</h2>
				<form id="form1" name="form1" method="post" action="control.php" class="form-horizontal well">
